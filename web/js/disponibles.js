//introduce los datos en un array
let todosLosVehiculos = [];
  //hace que la pagina inicial sea la primera
  let paginaActual = 1;
  //crea una constante que muestra 6 tarjetas por pagina 
  const VEHICULOS_POR_PAGINA = 6;

  //funcion que carga los vehiculos de la pagina desde el json disponibles
  async function cargarVehiculos() {
    const respuesta = await fetch('../json/disponibles.json');
  ...
  //funcion que carga la clase de la tarjeta, segun la cercania con el mantenimiento
  ...
  //funcion que muestra los vehiculos de forma paginada
